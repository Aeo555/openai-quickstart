...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--model_type', type=str, required=False, default='OpenAIModel', help='The type of translation model to use. Choose between "GLMModel" and "OpenAIModel".')
        ...
        self.parser.add_argument('--source_language', type=str, help='The source language of the file is')
        self.parser.add_argument('--target_language', type=str, help='The target language would like to translate it into')
